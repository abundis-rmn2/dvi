...
<script>
    ...
    var MUID = <?php echo json_encode($MUID); ?>;
    var nodeMinDegree = <?php echo intval($nodeMinDegree); ?>;
    var gravity = <?php echo floatval($gravity); ?>;
    var iterations = <?php echo intval($iterations); ?>;
    var scale = <?php echo floatval($scale); ?>;
    var adjustSizes = <?php echo $adjustSizes === 'true' ? 'true' : 'false'; ?>;
    var cleanEntities = <?php echo $cleanEntities === 'true' ? 'true' : 'false'; ?>;
    var barnesHutOptimize = <?php echo $barnesHutOptimize === 'true' ? 'true' : 'false'; ?>;
    var barnesHutTheta = <?php echo floatval($barnesHutTheta); ?>;
    var linLogMode = <?php echo $linLogMode === 'true' ? 'true' : 'false'; ?>;
    var outboundAttractionDistribution = <?php echo $outboundAttractionDistribution === 'true' ? 'true' : 'false'; ?>;
    var scalingRatio = <?php echo floatval($scalingRatio); ?>;
    var slowDown = <?php echo floatval($slowDown); ?>;
    var strongGravityMode = <?php echo $strongGravityMode === 'true' ? 'true' : 'false'; ?>;
    var nodeFixedSize = <?php echo $nodeFixedSize === 'true' ? 'true' : 'false'; ?>;
    var initialLayout = <?php echo json_encode($initialLayout); ?>;
    var autoGravityScale = <?php echo json_encode($autoGravityScale); ?>;
...
function normalize(value, min, max, newMin, newMax) {
    ...
    $("body").on("click", "#closenessizecentrality", function(e) {
        ...
        graph.nodes().forEach((entry) => {
          ...
          graph.setNodeAttribute(entry, 'size', (graph.getNodeAttributes(entry)['closenessCentrality']* 3) + 1);
    ...
    $("body").on("click", "#pageranksizecentrality", function(e) {
        ...
        graph.nodes().forEach((entry) => {
          //console.log(graph.getNodeAttributes(entry)['pagerank']);
          graph.setNodeAttribute(entry, 'size', (graph.getNodeAttributes(entry)['pagerank'] * 2111) + 1);
