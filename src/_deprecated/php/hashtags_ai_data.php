...
const MUID = <?php echo json_encode($MUID); ?>;
const nodeMinDegree = <?php echo intval($nodeMinDegree); ?>;
const gravity = <?php echo floatval($gravity); ?>;
const iterations = <?php echo intval($iterations); ?>;
const scale = <?php echo floatval($scale); ?>;
const adjustSizes = <?php echo $adjustSizes === 'true' ? 'true' : 'false'; ?>;
const barnesHutOptimize = <?php echo $barnesHutOptimize === 'true' ? 'true' : 'false'; ?>;
const barnesHutTheta = <?php echo floatval($barnesHutTheta); ?>;
const linLogMode = <?php echo $linLogMode === 'true' ? 'true' : 'false'; ?>;
const outboundAttractionDistribution = <?php echo $outboundAttractionDistribution === 'true' ? 'true' : 'false'; ?>;
const scalingRatio = <?php echo floatval($scalingRatio); ?>;
const slowDown = <?php echo floatval($slowDown); ?>;
const strongGravityMode = <?php echo $strongGravityMode === 'true' ? 'true' : 'false'; ?>;

const networkfilter = <?php echo $networkfilter_json; ?>;
